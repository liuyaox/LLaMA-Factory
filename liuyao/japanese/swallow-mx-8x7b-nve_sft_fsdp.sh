...
# -----------配置修改区------------
MODEL_PATH=/maindata/data/shared/public/ai_story/nlp_models/Japanese/tokyotech-llm/Swallow-MX-8x7b-NVE-v0.1
DATASET="japanese_synthetic_0516_mixtral8x7b"     # chat template直接使用mixtral8x7b的，数据也复用它的
TOTAL_SAMPLES=26481
RUN_GROUP=Swallow-MX-8x7b-NVE-v0.1_SFT
TAG="synthetic_0516"
# -------------------------------
