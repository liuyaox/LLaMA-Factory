...
pip install transformers==4.40.0    # 支持seallm7b-v2.5(虽然官方说Install the latest transformers(>4.40)，但4.38.2也OK)
...
# -----------配置修改区------------
MODEL_PATH=$DEPT_HOME/nlp_models/SeaLLMs/SeaLLM-7B-v2.5
DATASET="Indonesian_id_15.1_2_write0413_seallm7b-v2.5"
TOTAL_SAMPLES=4238
RUN_GROUP=SeaLLM-7B-v2.5_SFT
TAG="indonesian_id_15.1_2_write0413"
# -------------------------------
