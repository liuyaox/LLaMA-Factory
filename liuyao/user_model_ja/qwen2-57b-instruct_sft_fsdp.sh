...
export RUN_ROOT=$LY_HOME/user_model/japanese
...
export WANDB_PROJECT=linky_user_model_ja
...
#/maindata/data/user/ai_story/zhigong.wang/miniconda3/envs/lylf/bin/accelerate launch --machine_rank ${RANK} \
