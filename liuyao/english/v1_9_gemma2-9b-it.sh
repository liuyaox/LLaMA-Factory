...
pip install transformers==4.42.3   # 支持gemma2
...
# -----------配置修改区------------
MODEL_PATH=/maindata/data/shared/public/ai_story/nlp_models/google/gemma-2-9b-it
RUN_GROUP=gemma-2-9b-it_SFT
TEMPLATE="gemma"

DATASET="en_synthetic_v3_2_sfw,en_synthetic_v3_2_nsfw,en_synthetic_v3_2_normal"
TOTAL_SAMPLES=4950
V='v1_9'
TAG="synthetic_v3_2_all_cleaned"
