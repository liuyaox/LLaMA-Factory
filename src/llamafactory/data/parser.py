...
def get_dataset_list(dataset_names: Optional[Sequence[str]], dataset_dir: str) -> List["DatasetAttr"]:
    r"""
    Gets the attributes of the datasets. YAO：配置dataset_attr的各种参数，包括columns, tags等
    """
    ...
    for name in dataset_names:
        ...
        # YAO: 支持HF, ModelScope, script(可能也是HF上的数据，只不过需要额外处理下)和本地file四种形式
        ...
        # YAO: 数据注册里若是sharegpt格式，需要定义tags，以指定role_key, content_key, user_word, assistant_word等 TODO 取代之前的role和content字段？
